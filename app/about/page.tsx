...
const AboutPage = () => {
  ...
  const executiveCommittee: ExecutiveMember[] = [
    { name: 'Mr. John Doe', position: 'President' },
    { name: 'Mr. Jane Smith', position: 'Vice President' },
    { name: 'Mr. Robert Johnson', position: 'General Secretary' },
    { name: 'Ms. Sarah Williams', position: 'Treasurer' },
    { name: 'Mr. Michael Brown', position: 'Joint Secretary' },
    { name: 'Ms. Emily Davis', position: 'Member' },
    { name: 'Mr. David Wilson', position: 'Member' },
    { name: 'Ms. Lisa Anderson', position: 'Member' },
  ];
    ...
    <div className="min-h-screen bg-white text-gray-900 pt-[90px]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        ...
        <section id="history" className="mb-16 scroll-mt-24">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-700 leading-relaxed text-lg mb-4">
              Squash was introduced to Bangladesh in the early 1970s, primarily
              through British expatriates and diplomatic missions. The sport
              quickly gained popularity among the urban elite, with the first
              squash courts being established in Dhaka and Chittagong.
            </p>
            <p className="text-gray-700 leading-relaxed text-lg mb-4">
              The Bangladesh Squash Rackets Federation was officially formed in
              [Year] to provide structure and governance to the growing squash
              community. Since its inception, BSRF has been instrumental in
              organizing national championships, developing coaching programs,
              and representing Bangladesh in regional and international
              competitions.
            </p>
            <p className="text-gray-700 leading-relaxed text-lg mb-4">
              Over the decades, Bangladesh has produced several talented squash
              players who have represented the country in various international
              tournaments, including the Asian Squash Championships, South Asian
              Games, and other prestigious events.
            </p>
            <p className="text-gray-700 leading-relaxed text-lg">
              Today, BSRF continues to build on this rich heritage, working
              towards making squash more accessible and developing the next
              generation of champions who will carry forward Bangladesh&apos;s
              legacy in the sport.
            </p>
          </div>
        </section>
        ...
        <section id="vision-mission" className="mb-16 scroll-mt-24">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="group relative bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-xl border border-blue-200 transition-all duration-300 ease-in-out hover:scale-[1.02] hover:shadow-xl hover:shadow-blue-200/50 hover:border-blue-300 cursor-pointer">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-700 leading-relaxed group-hover:text-gray-800 transition-colors duration-300 ease-in-out">
                  To establish Bangladesh as a leading squash nation in South
                  Asia and create a sustainable ecosystem that nurtures talent
                  from grassroots to elite levels, producing world-class
                  athletes and promoting the sport across all segments of
                  society.
                </p>
              </div>
            </div>
            ...
            <div className="group relative bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-xl border border-green-200 transition-all duration-300 ease-in-out hover:scale-[1.02] hover:shadow-xl hover:shadow-green-200/50 hover:border-green-300 cursor-pointer">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-700 leading-relaxed group-hover:text-gray-800 transition-colors duration-300 ease-in-out">
                  To develop, promote, and govern the sport of squash in
                  Bangladesh through comprehensive programs, strategic
                  partnerships, and dedicated support for athletes, coaches, and
                  officials, ensuring the sport&apos;s growth and
                  sustainability.
                </p>
              </div>
            </div>
          ...
          <div className="bg-gray-50 p-8 md:p-10 rounded-xl border border-gray-200">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {[
                'Develop and implement comprehensive training programs for athletes at all levels',
                'Organize and promote national and international squash competitions',
                'Establish and maintain squash facilities across Bangladesh',
                'Train and certify coaches, referees, and technical officials',
                'Represent Bangladesh in international squash organizations and competitions',
                'Foster grassroots development and youth participation in squash',
              ].map((objective, index) => (
                <div
                  key={index}
