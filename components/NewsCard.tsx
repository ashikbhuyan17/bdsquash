...
const newsArticles: NewsArticle[] = [
  {
    id: '1',
    title: "SG Pipers beat Ranchi Royals 2-0 in the opening clash of Women's Hero Hockey India League",
    date: '2025.12.30',
  ...
  {
    id: '2',
    title: 'Hardik to lead HIL Governing Council Team while Sanjay and Arthur Van Doren name...',
    date: '2025.12.30',
    imageUrl: 'https://images.unsplash.com/photo-1556817411-58c45dd94e8c?w=800&h=600&fit=crop',
    category: 'hockey'
  },
  {
    id: '3',
    title: 'Asian Hockey Federation Conducts Executive Board Meeting 28th December 2025',
    date: '2025.12.28',
  ...
  {
    id: '4',
    title: 'Historic victory for Bangladesh Hockey team in Asian Champions Trophy',
    date: '2025.12.27',
  ...
  {
    id: '5',
    title: 'National Squash Championship Finals: Record breaking performances witnessed',
    date: '2025.12.26',
  ...
  {
    id: '7',
    title: 'International Squash Federation approves Bangladesh hosting rights for 2026',
    date: '2025.12.24',
  ...
  {
    id: '8',
    title: 'Bangladesh Hockey Federation announces new coaching staff for national team',
    date: '2025.12.23',
  imageUrl: 'https://images.unsplash.com/photo-1554068865-24cecd4e34b8?w=800&h=600&fit=crop',
    category: 'hockey'
  },
  ...
  const renderNewsGrid = (articles: NewsArticle[]) => {
    ...
    while (index < articles.length) {
      ...
      if (isEvenGroup) {
        ...
        gridItems.push(
          <div key={`group-${groupNumber}`} className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
