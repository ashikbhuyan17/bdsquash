...
const navigationConfig = {
  ...
  newsPress: {
    label: 'NEWS & PRESS',
    items: [
      { href: '/latest-news', label: 'News & Announcements' },
                  ...
                  <div className="flex flex-col h-full">
                    ...
                    <nav className="flex flex-col space-y-2 pt-4">
                      ...
                      <SheetClose asChild>
                        <Link
                          href="/news"
                          className="px-4 py-3 text-sm font-medium uppercase hover:bg-gray-100 rounded-md transition-colors border-b"
